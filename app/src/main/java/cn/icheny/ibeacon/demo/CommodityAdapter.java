...
public class CommodityAdapter extends BaseAdapter {
	...
	class ViewHolder {
		...
		public ViewHolder(View view) {
			commodity_id = (TextView) view.findViewById(R.id.commodity_id);
			commodity_icon = (ImageView) view.findViewById(R.id.commodity_icon);
			commodity_desc = (TextView) view.findViewById(R.id.commodity_desc);
			commodity_distance = (TextView) view.findViewById(R.id.commodity_distance);
		}
	}
}
